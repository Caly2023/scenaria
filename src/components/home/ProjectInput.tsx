    ...
    <div className="w-full md:max-w-4xl md:mx-auto md:space-y-6">
      <motion.div 
        ...
        className={cn(
          ...
          "max-md:fixed max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:rounded-b-none max-md:rounded-t-[32px] max-md:z-[100] max-md:pb-[calc(0.75rem+env(safe-area-inset-bottom))]"
        )}
      >
        <div className="flex flex-col">
          {/* Row 1: Input Area */}
          <div className="px-5 pt-1.5 pb-0 md:pt-4 md:pb-1">
            <textarea
              ref={textareaRef}
              value={storyIdea}
              onChange={(e) => {
              ...
              className={cn(
                ...
                "text-[16px] md:text-[17px] min-h-[24px] md:min-h-[32px]"
              )}
            />
          </div>

          {/* Row 2: Action Bar */}
          <div className="px-4 pb-1.5 md:pb-3 pt-0 flex items-center justify-between">
            {/* Left Actions */}
